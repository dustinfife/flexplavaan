...
In this paper, we introduce `flexplavaan`, which is an amalgamation of the model-plotting capabilities of `flexplot` [@Fife2019c] and the latent variable modeling capabilities of `lavaan` [@lavaan]. Before we introduce `flexplavaan` and its core functions, however, we explain the types of graphics used and the rationale behind them. 
