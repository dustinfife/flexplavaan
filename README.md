...
<br>
<img src="README_files/figure-gfm/force-1.png" title="Simulated dataset with crossloadings on the 'history' indicator." alt="Simulated dataset with crossloadings on the 'history' indicator." width="80%" />
<br>
...
<img src="README_files/figure-gfm/nonlinear-1.png" title="Simulated dataset with nonlinear relationship. \label{fig:nonlinear}" alt="Simulated dataset with nonlinear relationship. \label{fig:nonlinear}" width="80%" />
...
Figure @ref(fig:finalmod) shows that the approximation works fairly
well. Though there is *some* misfit evident in the
disturbance-dependence plots, for the most part, the approximation
captures the essential features of the nonlinear relationships.
