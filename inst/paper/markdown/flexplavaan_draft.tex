...
\begin{verbatim}
## Called from: visualize.lavaan(object, object2, subset, plot, formula, sort_plots, 
##     ...)
## debug at /Users/dustinfife/Documents/RPackages/flexplavaan/R/visualize.R#92: if (length(get_endogenous_names(object_l)) < 2) stop("You cannot do a latent plot when there's less than two endogenous variables.")
## debug at /Users/dustinfife/Documents/RPackages/flexplavaan/R/visualize.R#93: p = latent_plot(object, object2, formula, ...)
## debug at /Users/dustinfife/Documents/RPackages/flexplavaan/R/visualize.R#94: return(p)
\end{verbatim}
